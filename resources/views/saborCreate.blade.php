...
<body>
        ...
        <nav class="navbar">
            <div class="container-fluid">
                ...
                <ul class="nav justify-content-center">
                    <li class="nav-item">
                        <a href="/jumex/create" class="nav-link" href="#">Crear Jugo</a>
                    </li>
                    <li class="nav-item">
    ...
    <br>
    <div class="f">
        <form class="form" method="POST" action="/sabor" id="formulario">
        @csrf
            <div class="mb-3">
                <label for="Sabores" class="form-label">Sabor</label>
                <input type="text" class="form-control" name="Sabores" id="Sabores">
            </div>
