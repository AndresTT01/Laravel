...
<html>
	...
	<body>
		...
		<div class="f">
			<form class="form" method="POST" action="/sabor/{{$sa->id}}" id="formulario">
			@csrf
			@method('patch')
				<div class="mb-3">
					<label for="Nombre" class="form-label">Sabores</label>
					<input type="text" class="form-control" name="Sabores" id="Sabores" value="{{$sa->Sabores}}">
				</div>
